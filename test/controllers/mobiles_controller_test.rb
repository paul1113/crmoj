...
class MobilesControllerTest < ActionController::TestCase
  ...
  test "should create mobile" do
    assert_difference('Mobile.count') do
      post :create, mobile: { national: @mobile.national, number: @mobile.number, type: @mobile.type, uuid: @mobile.uuid }
    end
  ...
  test "should update mobile" do
    patch :update, id: @mobile, mobile: { national: @mobile.national, number: @mobile.number, type: @mobile.type, uuid: @mobile.uuid }
    assert_redirected_to mobile_path(assigns(:mobile))
  end
