...
class PhonesControllerTest < ActionController::TestCase
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post :create, phone: { city: @phone.city, extension: @phone.extension, national: @phone.national, number: @phone.number, type: @phone.type, uuid: @phone.uuid }
    end
  ...
  test "should update phone" do
    patch :update, id: @phone, phone: { city: @phone.city, extension: @phone.extension, national: @phone.national, number: @phone.number, type: @phone.type, uuid: @phone.uuid }
    assert_redirected_to phone_path(assigns(:phone))
  end
